    ...
    <div className="flex flex-col h-full overflow-hidden bg-transparent">
      <div className="p-3 border-b flex-shrink-0 space-y-3 bg-background">
        ...
        <ToggleGroup type="single" value={unreadFilter} onValueChange={(val) => val && setUnreadFilter(val)} className="justify-start">
          <ToggleGroupItem value="all" size="sm" className="text-xs rounded-full px-4 data-[state=on]:bg-primary data-[state=on]:text-primary-foreground">All</ToggleGroupItem>
          <ToggleGroupItem value="unread" size="sm" className="text-xs rounded-full px-4 data-[state=on]:bg-primary data-[state=on]:text-primary-foreground">Unread</ToggleGroupItem>
        </ToggleGroup>
      </div>
